...
namespace RoadScholar.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        [AllowAnonymous]
        public ActionResult StudentLogin(string returnUrl, bool flag=false)
        {
        ...
        public async Task<ActionResult> TeacherLogin(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToAction("Dashboard", "Teacher", new {Email = model.Email});
        ...
        public async Task<ActionResult> Register(TeacherRegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new BL.ApplicationUser { UserName = model.Email, Email = model.Email };
